...
inline Scene Texture_Mapping(void)
{
    Scene scene;
    ...
    // Textures
    Texture floor_texture    = Texture_Init_Checker((vec2){0.0, 0.0}, 0.0, (vec2){16.0, 16.0}, (vec4){0.0, 0.0, 0.0, 1.0}, (vec4){0.0, 0.0, 0.0, 1.0});
    Texture sphere_texture   = Texture_Init_Checker((vec2){0.0, 0.0}, 0.0, (vec2){16.0, 16.0}, (vec4){0.2, 0.2, 0.8, 1.0}, (vec4){0.8, 0.8, 0.2, 1.0});
    Texture cylinder_texture = Texture_Init_Checker((vec2){0.0, 0.0}, 0.0, (vec2){4.0 * M_PI, 4.0}, (vec4){1.0, 0.5, 0.0, 1.0}, (vec4){0.8, 0.8, 0.2, 1.0});
    Texture cone_texture     = Texture_Init_Checker((vec2){0.0, 0.0}, 0.0, (vec2){8.0 * (M_PI / 2.0), 8.0}, (vec4){0.2, 0.2, 0.8, 1.0}, (vec4){1.0, 0.5, 0.0, 1.0});
